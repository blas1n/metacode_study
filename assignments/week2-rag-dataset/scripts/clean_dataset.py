#!/usr/bin/env python3
"""Clean the synthetic BSVibe memory dataset for a future RAG database import."""
...
def infer_note_type(source_type: str) -> str:
    mapping = {
        ...
        "feedback": "repeated_pattern_candidate",
        "delivery_report": "delivery_evidence",
        "github_issue": "external_context",
        "project_doc": "project_knowledge",
    }
    return mapping.get(source_type, "knowledge_note")
